...
var CATWORD_ = [
  ['醫療', '醫院|診所|藥局|藥師|健保|掛號|看診|處方|牙醫|眼科|皮膚科'],
  ['住宿', '飯店|hotel|airbnb|民宿|住宿|旅館|青旅'],
  ['交通', '捷運|高鐵|台鐵|火車|計程|uber(?!\\s?eats)|taxi|停車|加油|中油|油錢|客運|公車|ubike|悠遊卡|一卡通|icash儲值|機票|航空|租車|過路費'],
  ['娛樂', '電影|影城|ktv|遊戲|steam|netflix|spotify|disney|訂閱|展覽|演唱會|門票'],
  ['生活', '全聯|家樂福|大潤發|超市|costco|好市多|日用|藥妝|屈臣|康是美|寶雅|美妝|保養|化妝|眼藥水|藥膏|感冒藥|維他命|洗衣|理髮|剪髮|美容|水電|電費|水費|瓦斯|電信|手機費|網路費'],
  ['購物', '購物|百貨|shopee|蝦皮|momo|pchome|博客來|amazon|淘寶|服飾|衣服|鞋|uniqlo|zara|3c|電器|家電'],
